/*
1. Получает year как целое число.
2. Возвращает true, если год высокосный, и false - если нет.
3. Если получила неправильные данные, выбрасывает ошибку с нужным текстом.
...
2008.6 - error 'year must be integer'
...
describe("test isLeapYear function", ()=> {
    ...
    test("2008.6 - error 'year must be integer'", ()=> {
        expect(() => isLeapYear(2008.6)).toThrow('year must be integer');
    })
